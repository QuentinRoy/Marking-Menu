...
export default defineConfig([
  ...
  },
  {
    ...
    // build, so they must import `marking-menu`: that is where both their
    // behavior and their types come from. Linting them reads `dist/`, which
    // is why `yarn lint` builds first.
    files: ['demo/**', 'e2e/**'],
    rules: {
